...
- Can study properties of the estimator based on one sample only

---

# Properties of our estimator

- Here, we could derive properties because we had many samples
...
- Distribution of our estimates centered around the true population parameter
...
- We want estimates from any to be close from one another
...
- Conditions under which the OLS estimator is **optimal**

- Optimal: unbiased estimator with the smallest possible variance (Best Linear Unbiased Estimator, BLUE)
...
- Constant conditional variance of the error term
...
- We described these properties and some necessary conditions for these properties to hold
