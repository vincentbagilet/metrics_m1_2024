...
This course aims to introduce regression methods for economic research and general method to test hypothesis. It shall provide fundamental tools to quantitatively explore relevant social science questions.
...
5.  [Convergence in ](4_convergence.qmd)[probability](5_convergence.qmd): How to show the convergence of an extremum estimator?
6.  [Asymptotic normality](6_asynorm.qmd): How to derive the asymptotic distribution of an estimator?
7.  [Hypothesis testing - Theory](7_test_theo.qmd): How to construct a good statistical test?
