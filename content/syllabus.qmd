...
-   [Vincent Bagilet](https://vincentbagilet.github.io/): [`r fontawesome::fa("envelope")` vincent.bagilet\@gmail.com](mailto:vincent.bagilet@gmail.com){.email} (4 first lectures)
...
-   [Lucile Laugrette](https://sites.google.com/view/lucilelaugerette/home): [`r fontawesome::fa("envelope")` lucile.laugerette\@gmail.com](mailto:lucile.laugerette@gmail.com){.email} (R TD)

## Class Meeting Times

`r fontawesome::fa("book-open")` Lectures: Tuesday 8:30am - 11:30am

`r fontawesome::fa("laptop")` TD:

`r fontawesome::fa("pencil")` Exam: Tuesday November 19

## Course Objectives and Overview

This course aims to introduce regression methods for economic research. It shall provide fundamental tools to quantitatively explore relevant social science questions.
...
1.  [Linear regression](1_linear_regression.qmd): Introduction and refresher to linear regression
2.  [OLS properties](2_ols_properties.qmd): What are the properties and assumptions behind OLS?
3.  [Model specification](3_model_selection.qmd): How to define a sensible model describing the relationships between the variables of interest?
4.  [Covariates selection](4_covariates_selection.qmd): How to decide which variables to include in the model?

## Prerequisites

A basic background in econometrics and statistics is required for this course. A good understanding of linear algebra is also necessary. No prior knowledge of R is required, although some programming experience is a plus.
...
A computer-based test will be held at the end of the semester. You will be given a dataset with a set of questions to perform applied analysis including estimation, hypothesis testing, the detection and correction of estimation issues, and inference.
...
You will write a short standalone report (5 pages maximum) and present your code and analysis in a Rmarkdown document.
