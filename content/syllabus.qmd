...
5.  and 6. [Large sample properties](lect/lect_5_6.qmd): How to show the convergence and asymptotic distribution of estimators
6.  [Hypothesis testing - Theory](7_test_theo.qmd): How to construct a good statistical test?
7.  [Hypothesis testing - Application](8_test_app.qmd): Which hypothesis can I use based on a specific (set) of hypothesis?
