...
`r fontawesome::fa("file-powerpoint")` [Open slides](../slides/lecture_4/slides_4_model_selection.html)

```{r out.width='100%'}
#| echo: false

knitr::include_url("../slides/lecture_4/slides_4_model_selection.html")
```

## Exercise

I will publish the exercise shortly.
