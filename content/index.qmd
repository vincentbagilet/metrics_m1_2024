...
::: callout-caution
This course will make an extensive use of R and RStudio. Please install it before class. You can find instructions [here](https://r4ds.hadley.nz/intro#prerequisites).
:::
